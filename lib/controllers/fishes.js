...
module.exports = Router()
  ...
  // you can still make this a delete route even though you're not "technically" deleting
  // see feedback for thoughts on soft deletes
  .delete('/:id', authenticate, async (req, res, next) => {
    try {
      const deleteFish = await Fish.updateById(req.params.id, {
